...
## State Senate 45 ####
processed_statesen47 <- process_ny_data(read_excel("NY_Saratoga/Saratoga_NY_GE20_cleaned.xlsx", sheet = "statesen47"),
                                        "State Senate", 
                                        "47")
...
## State House 114 ####
processed_statehou117 <- process_ny_data(read_excel("NY_Saratoga/Saratoga_NY_GE20_cleaned.xlsx", sheet = "statehou117"),
                                         "State Assembly", 
                                         "117")
