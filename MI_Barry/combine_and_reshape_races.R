...
processed_cd03 <- reshape_precinct_data(read_excel(infile_string, sheet = "cd03"), 
                                  "U.S. House", 
                                  "03")
processed_cd03
...
## State House 87  ####
processed_statehou87 <- reshape_precinct_data(read_excel(infile_string, sheet = "statehou87"),
                                        "State House", 
                                        "87")
processed_statehou87
...
#note: for Barry County there were no registered voters listed, it was all zeros (0). So just total ballots done here.
processed_reg_and_ballots <- read_excel(infile_string, sheet = "total_reg_and_cast")
#this one requires a little manual processing as well to finish up
